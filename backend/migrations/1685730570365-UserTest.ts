...
export class UserTest1685730570365 implements MigrationInterface {
    name = 'UserTest1685730570365'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "achievements" TO "winningStreak"`);
        await queryRunner.query(`ALTER TYPE "public"."user_achievements_enum" RENAME TO "user_winningstreak_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "winningStreak"`);
        await queryRunner.query(`ALTER TABLE "user" ADD "winningStreak" "public"."user_winningstreak_enum" array NOT NULL DEFAULT '{}'`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."user_winningstreak_enum" RENAME TO "user_achievements_enum"`);
        await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "winningStreak" TO "achievements"`);
    }
